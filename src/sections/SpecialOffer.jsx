  ...
  return (
    <section className="flex justify-center items-center flex-wrap max-xl:flex-col-reverse gap-10 max-container">
      ...
      <div className="flex flex-1 flex-col">
        <h2
          className="font-palanquin text-4xl capitalize max-sm:text-[72px] font-bold
        lg:max-w-lg">
        ...
        <p className="mt-6 lg:max-w-lg info-text">
          Navigate a real of possibilities designed to fulfill your unique desires, surpassing the loftiest expectations. Your journey with us is nothing short of exceptional.
        </p>
